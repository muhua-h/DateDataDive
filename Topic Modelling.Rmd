...
```{r}
thought1 <- findThoughts(prev5, texts = df_about_me$my_self_summary, topic = 1, n = 1)
thought2 <- findThoughts(prev5, texts = df_about_me$my_self_summary, topic = 2, n = 1)
thought3 <- findThoughts(prev5, texts = df_about_me$my_self_summary, topic = 3, n = 1)
thought4 <- findThoughts(prev5, texts = df_about_me$my_self_summary, topic = 4, n = 1)
thought5 <- findThoughts(prev5, texts = df_about_me$my_self_summary, topic = 5, n = 1)
```
